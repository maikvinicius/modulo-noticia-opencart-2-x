<?php
class ControllerNoticiasNoticia extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('information/noticias');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('information/noticia')
		);
	...
	public function success() {
		$this->load->language('information/noticia');
